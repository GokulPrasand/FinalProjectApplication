    ...
    <div  class="container-fluid" >
        ...
        <div class="row">
            <div class="text-center">
                 <h3 style="color: rgb(240, 93, 9);font-style: italic">COMPLAINTS</h3>
            </div>
        </div>
    	...
    	<div class="row">
	    	...
	    	<div class="col-md-10" >
                    ...
                    <table class="table table-striped caption-top" style="background-color:#f8f9fa;border-radius:5px;">
                        <caption style="color:#9708e9;font-weight:bold;text-align: center;">Complaints of Vendors</caption>
                        <thead>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>${r.complaint }</td>
                            <td>
                                <!--  -iv class="col-12" style="text-align: center;">
                                    <button type="submit" name="deletereview" id="deletereview"  class="btn btn-success">Delete Review</button>
                                </div>-->
                                <div class="col-12" style="text-align: center;">
                            		<a class="btn btn-block btn-danger mb-1" href="deletereview/${r.vendorid}/${r.foodieid}/${r.complaint}">Delete Review</a>
                          		</div>
                            </td>
                        </tr>
                        </c:forEach>
