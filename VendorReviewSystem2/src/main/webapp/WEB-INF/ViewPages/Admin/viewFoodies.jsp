    ...
    <div  class="container-fluid" >
        ...
        <div class="row">
            <div class="text-center">
                 <h3 style="color: rgb(240, 93, 9);font-style: italic">FOODIE DETAILS</h3>
            </div>
        </div>
    	...
    	<div class="row">
	    	...
	    	<div class="col-md-10" >
                ...
                <table class="table table-striped caption-top" style="background-color:#f8f9fa;border-radius:5px;">
                    <caption style="color:#9708e9;font-weight:bold;text-align: center;">Foodie List</caption>
                    <thead>
                    <tr>
                        <th scope="col">Id</th>
