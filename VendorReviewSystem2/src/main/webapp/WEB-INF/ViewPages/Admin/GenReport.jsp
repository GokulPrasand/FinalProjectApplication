...
<script src='main.js'></script> <!-- Bootstrap CSS -->
...
<h3 style="color: rgb(240, 93, 9);font-style: italic">GENERATE REPORT</h3>
</div>
</div>
...
<div class="col-md-6" >
<form class="row g-15" name="f3" method="post" action="" >
<div class="col-md-6">
...
<!--<button type="submit" name="submitg" id="submitg" class="btn btn-info">Genereate Report</button>-->
<a href="downloadxl" class="btn btn-info" style="text-align: center;">Download Excel File</a>
</div>
