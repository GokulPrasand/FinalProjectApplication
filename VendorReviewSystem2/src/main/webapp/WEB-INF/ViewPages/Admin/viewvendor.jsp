    ...
    <div  class="container-fluid" >
        ...
        <div class="row">
            <div class="text-center">
                 <h3 style="color: rgb(240, 93, 9);font-style: italic">VENDOR DETAILS</h3>
            </div>
        </div>
              ...
              <div class="navbar navbar-dark bg-primary" id="navbarNavAltMarkup">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                 ...
                 <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="btn btn-block btn-dark mb-1"    href="ab">Logout</a>
                  </li>&nbsp; &nbsp; &nbsp; &nbsp;
                </ul>
              </div>
            </div>
	    	...
	    	<div class="col-md-8" >
                ...
                <div class="row"  >
                    ...
                    <div class="col-md-6" style="text-align: center;">
                        <h6 style="color:#9708e9;text-decoration: underline; ">VENDOR DETAILS</h6>
                    </div>
                    <div class="col-md-3"></div>
                </div>
                <table width="100%" class="table table-striped" border="1" style="text-align:center; background-color:f8f9fa; border-spacing:12px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-block btn-success mb-1"   href="activate/${v.vendorid }">Activate</a>
                        </td>
                        <td>
                            <a class="btn btn-block btn-warning mb-1"    href="deactivate/${v.vendorid }">Deactivate</a>
                        </td>
                        <td>
                            <a class="btn btn-block btn-danger mb-1"    href="delete/${v.vendorid }">Delete</a>
                        </td>
                    </tr>
                      </c:forEach>
