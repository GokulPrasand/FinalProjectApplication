...
<div  class="container-fluid" >
    ...
    <div class="row">
        <div class="text-center">
             <h2 style="color: rgb(240, 93, 9);font-style: italic">VENDOR HOME</h2>
        </div>
    </div>
    ...
    <div class="row" style="min-height: 70px;">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 text-center">
                ...
                <h1 style="font-style:italic; color: maroon;">WELCOME ${v.vendorname}</h1>  

                <h1 style="font-style:italic; color: maroon;">Your vendor id is ${v.vendorid}</h1>  
