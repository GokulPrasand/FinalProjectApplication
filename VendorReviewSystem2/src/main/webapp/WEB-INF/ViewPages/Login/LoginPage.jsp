...
<body style="background-color:rgb(206, 203, 36); background-image:url(https://images.pexels.com/photos/733857/pexels-photo-733857.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260); background-size:cover; background-repeat: no-repeat;background-position: center;">    <!-- Option 1: Bootstrap Bundle with Popper -->
    ...
    <div class="container-fluid">
        ...
        <div class="nav">
	<div class="left">
		<span>VENDOR REVIEW SYSTEM</span>
	</div>
</div>
            ...
            <div class="col-md-4">
                ...
                <div  style="background-color:white">
                    ...
                    <br />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <a href="forgotpassword" style="color: rgb(201, 41, 89); ">Forgot Password?</a>
                            </div>
                            <div class="col-md-4">

                            </div>
                            <div class="col-md-4">
                                <a href="forgotuserid" style="color: rgb(201, 41, 89);">Forgot Username?</a>
                            </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="row" style="text-align: center;">
                            ...
                            <div class="col-md-12" style="text-align: center;">
                                    <a class="btn btn-block btn-info col-lg-4" style="color:darkblue" href="foodieReg">Register New Foodie</a>
                            </div>
                    </div>
                    ...
                    <div class="row" style="text-align: center;">
                        <div class="col-md-12" style="text-align: center;">
                            <a class="btn btn-block btn-info col-lg-4" style="color:darkblue;" href="vendorReg">Register New Vendor</a>
                        </div>
                    </div>
                    <div class="row" style="min-height: 60px;">
                    </div>
                    <div class="row" style="text-align: center;">
                        <div class="col-md-12" style="text-align: center;">
                            <a class="btn btn-block btn-info col-lg-4" style="color:darkblue;" href="viewReviewLogin">   View   Review     </a>
                        </div>
                    </div>
                </div>
            </div>
