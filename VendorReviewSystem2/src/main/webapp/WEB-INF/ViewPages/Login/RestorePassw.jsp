...
<body style="background-color:rgb(206, 203, 36); background-image:url('https://images.pexels.com/photos/317356/pexels-photo-317356.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500'); background-size: cover;">
    ...
    <div class="container-fluid" >
        <div class="row">
            ...
            <div class="col-md-4" >
                <div class="row">
                    <h4 style=" text-align: center;font-style: italic; color: rgb(55, 13, 243);">RESTORE YOUR PASSWORD</h4>
                </div>
                <div class="row" style="min-height: 7px;">
                </div>

                <form class="row g-15" name="f1" method="post" action="restorepassword" >
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-12">
                        <label for="txtvname" class="form-label">User ID</label>
                ...
                <div>
                    <h5 style="color:rgb(240, 17, 17); text-align: center;">${msg }</h5>
                </div>
